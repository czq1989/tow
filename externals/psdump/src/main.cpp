...
int main(int argc, char **argv)
{
  ...
  while (1) {
	...
	char path[2][300] = 
	{
		"D:\\TDDownload\\psdump-master\\psdump-master\\vcproj\\Debug\\psdump.exe",
		"test.psd"
	};
...
// 	argc = 2;
// 	argv = temp;
// 	temp[0] = (char *)malloc(300);
// 	temp[1] = (char *)malloc(300);
// 	memcpy(temp[0],path[0], 300);
// 	memcpy(temp[1], path[1], 300);
// 
// 
// 	
