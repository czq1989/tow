/*
    ...
    OpenGL loader generated by glad 0.1.34 on Fri Nov  6 06:03:23 2020.
    ...
    Commandline:
        --profile="core" --api="gl=4.3" --generator="c-debug" --spec="gl" --extensions="GL_KHR_debug"
    Online:
        https://glad.dav1d.de/#profile=core&language=c-debug&specification=gl&loader=on&api=gl%3D4.3&extensions=GL_KHR_debug
*/
...
// added by czq on 2020/11/6
#ifndef GLAD_USE_DEBUG_CALLBACK
    #define _pre_call_callback(...) (void)(0)
    #define _post_call_callback(...) (void)(0)
#endif
